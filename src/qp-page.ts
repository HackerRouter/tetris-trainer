...
export class QuickPlayPage {
  ...
  update() {
    ...
    if (ally) {
      ...
      el('qp-bot-state').textContent = `${ally.life.toUpperCase()} · ${ally.engine.stats.pieces} pieces · ${ally.engine.stats.garbage.sent} sent · ${ally.practiceTopout ? 6 : qp.settings.quickplay.bot.pps} PPS input pace`;
